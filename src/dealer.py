...
class Dealer:
    def __init__(self, v):
        ...
        self.prec['A'] = 12
        self.prec['2'] = 13
        with open('test/benchmark.dat') as f:
            self.games = [tuple([x.split(' ') for x in line.strip().split('\t')]) for line in f]
        # self.games = ((['A', 'A'], ['2', '3', '3']),
        #               (['2', 'A', 'A', '4', '3'], ['A', '10', '9', '5', '3']),
        #               (['3', '3', '4', '5', '5', '6', '7', '8', '8', '9', '9', '9', '10', 'J', 'J', 'Q', 'K','K', 'A', '2', '2', '2'], ['3', '3', '4', '6', '6', '6', '7', '7', '8', '8', '10', '10', 'Q', 'K', 'A', 'A', '2']),
        #               (['3', '4', '4', '4', '5', '5', '6', '7', '7', '8', '8', '8', '9', '10', '10', '10', 'J', 'J', 'Q', 'Q', 'K', 'K', 'A', 'A', 'A', 'A'], ['3', '3', '3', '4', '5', '5', '6', '6', '6', '7', '7', '8', '9', '9', '9', '10', 'J', 'J', 'Q', 'Q', 'K', 'K', '2', '2', '2', '2']),
        #               (['3', '3', '3', '4', '4', '4', '5', '5', '6', '6', '7', '7', '8', '8', '9', '10', '10', '10', 'J', 'J', 'J', 'Q', 'K', 'K', 'A', '2'], ['3', '4', '5', '5', '6', '6', '7', '7', '8', '8', '9', '9', '9', '10', 'J', 'Q', 'Q', 'Q', 'K', 'K', 'A', 'A', 'A', '2', '2', '2'])
        #               )
